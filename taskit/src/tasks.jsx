    ...
    <div className="container">
      ...
      {task.length !== 0 ? (
        <table className="table">
          <thead>
            <tr>
              <th scope="col" onClick={() => sortByColumn("title")}>
                Task
              </th>
              <th scope="col" onClick={() => sortByColumn("description")}>
                Description
              </th>
              <th scope="col" onClick={() => sortByColumn("duedate")}>
                Due Date
              </th>
          ...
          <tbody>
            {Array.isArray(task) ? (
              //task.map((aTask) => (
              task
                .sort((a, b) => sortByColumnValue(a, b, sortColumn, sortOrder))
                .map((aTask) => (
                  <tr key={aTask.id}>
